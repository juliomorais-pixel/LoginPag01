              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Align(
                      ...
                      child: Padding(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(8.0),
                          child: Image.asset(
                            'assets/images/ChatGPT_Image_9_de_set._de_2026,_00_13_50.png',
                            width: 350.0,
                            height: 200.0,
                            fit: BoxFit.contain,
                          ),
                    ...
                    GradientText(
                      'Toda a burocracia reunida em uma única tela que não carrega.',
                    ...
                    Text(
                      'Acesse seus documentos pendentes, benefícios em análise e serviços públicos com lentidão, instabilidade e sem promessas.',
                      textAlign: TextAlign.center,
                    ...
                    Text(
                      'Preencha as Informações Pessoais abaixo:',
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            font: GoogleFonts.inter(
                              fontWeight: FlutterFlowTheme.of(context)
                                  .bodyMedium
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed(CadastroPage2Widget.routeName);
                      },
                      text: 'Próximo',
                      options: FFButtonOptions(
                        width: 150.0,
