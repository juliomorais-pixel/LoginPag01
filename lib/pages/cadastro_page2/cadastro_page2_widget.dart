...
import 'cadastro_page2_model.dart';
export 'cadastro_page2_model.dart';

class CadastroPage2Widget extends StatefulWidget {
  const CadastroPage2Widget({super.key});

  static String routeName = 'CadastroPage2';
  static String routePath = '/cadastroPage2';

  @override
  State<CadastroPage2Widget> createState() => _CadastroPage2WidgetState();
}

class _CadastroPage2WidgetState extends State<CadastroPage2Widget> {
  late CadastroPage2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CadastroPage2Model());
            ...
            children: [
              Row(
                ...
                children: [
                  FFButtonWidget(
                    onPressed: () async {
                      context.pushNamed(CadastroPageWidget.routeName);
                    },
                    text: 'Voltar',
                    icon: Icon(
                      Icons.chevron_left,
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Preencha as Informações de Endereço abaixo:',
                      style: FlutterFlowTheme.of(context).bodyMedium.override(
                            font: GoogleFonts.inter(
                              fontWeight: FlutterFlowTheme.of(context)
                                  .bodyMedium
                          ...
                          child: Container(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                alignLabelWithHint: false,
                                hintText: 'Ex: Travessa, Padaria e etc',
                                hintStyle: FlutterFlowTheme.of(context)
                                    .labelMedium
                                    .override(
                                      font: GoogleFonts.inter(
                    ...
                    FFButtonWidget(
                      onPressed: () async {
                        context.pushNamed(CadastroPage3Widget.routeName);
                      },
                      text: 'Próximo',
                      options: FFButtonOptions(
                        width: 150.0,
